 ...
 * This is a one state Turing machine.
 * @author ruijieouyang
 */
class Turing {
     ...
     * Delta is stored as an array of Linkedlist.Each element in linked list 
     * is an array that stores the see character, new state changed to, the new char
     * to write to and the move direction, left and right.
     *
    ...
    public String execute(String input) {
        ...
        //while haven't reach halt state q1
